        ...
        <main class="min-h-screen bg-white px-4 py-10">
            <div class="mx-auto max-w-7xl">
                <div class="mb-8 flex flex-wrap items-center gap-3">
                    ...
                    <Link v-if="$page.props.auth.user?.role === 'admin'" :href="route('art.create', namespace)" class="rounded-full bg-neutral-900 px-4 py-2 text-sm font-semibold text-white">
                        Nuova immagine
                    </Link>
                </div>
                ...
                <div class="columns-1 gap-4 sm:columns-2 xl:columns-3">
                    <article v-for="(artwork, index) in artworks.data" :key="artwork.id" class="group mb-4 break-inside-avoid overflow-hidden rounded-xl border bg-neutral-50 shadow-sm">
                        ...
                        <div class="p-4">
                            ...
                            <Link v-if="$page.props.auth.user?.role === 'admin'" :href="route('art.edit', artwork.id)" class="mt-3 inline-block text-sm font-semibold text-neutral-600">
                                Modifica
                            </Link>
                        </div>
                    </article>
